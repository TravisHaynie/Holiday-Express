...
router.get('/notes', (req, res) => {
  res.sendFile(path.join(__dirname, '/..public/notes.html')); // Sending notes.html file as response
});

// Route to serve the index.html page for all other routes
router.get('/html', (req, res) => {
  res.sendFile(path.join(__dirname, '../public/index.html')); // Sending index.html file as response
});
